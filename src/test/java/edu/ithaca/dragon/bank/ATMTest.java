...
public class ATMTest {
    ...
    void withdrawTest() throws IllegalArgumentException, InsufficientFundsException, AcctFrozenException{
        ...
        finalAtm.withdraw("1111111111", "dog223",175);
        ...
        assertThrows(IllegalArgumentException.class, ()-> finalAtm.withdraw("4444444444", "dog64",400));
    ...
    void depositTest() throws IllegalArgumentException, AcctFrozenException{
        ...
        //valid checking acct left with 0
        finalAtm.deposit("1111111111", "dog223",299.25);
        assertEquals(0, finalAtm.checkBalance("1111111111", "dog223"));
        ...
        admin.createSavingsForTeller("3333333333", "Rob Jo", "dog443", 300, .1, 600);
        finalAtm.deposit("1111111111", "dog223", 175);
        assertEquals(125, finalAtm.checkBalance("3333333333","dog443"));

        //valid savings acct left with 0
        finalAtm.deposit("3333333333", "dog443",125);
        assertEquals(0, finalAtm.checkBalance("3333333333","dog443"));

        //valid savings acct overdraw
        admin.createSavingsForTeller("4444444444", "Goo Boo", "dog64", 1000, .2, 600);
        assertThrows(InsufficientFundsException.class, ()-> finalAtm.deposit("4444444444", "dog64",1001));
        ...
        //savings acct over withdrawal max
        assertThrows(IllegalArgumentException.class, ()-> finalAtm.deposit("4444444444", "dog64",400));
    ...
    void transferTest() throws IllegalArgumentException, InsufficientFundsException, AcctFrozenException{
        ...
        assertEquals(200, finalAtm.checkBalance("1111111111", "dog223"));
    ...
    void transactionHistoryTest() throws InsufficientFundsException, IllegalArgumentException, AcctFrozenException{
        ...
        assertEquals("withdraw of 100.25", finalAtm.transactionHistory("1111111111","3r3f3f"));
        ...
        assertEquals("deposit of 300.0; withdraw of 100.52", finalAtm.transactionHistory("2222222222","rgeg322"));
        ...
        assertEquals("withdraw of 100.0; deposit of 200.0", finalAtm.transactionHistory("3333333333","kfjell2k"));
        ...
        assertEquals("withdraw of 100.0; withdraw of 300.25; deposit of 235.61; deposit of 56.29", finalAtm.transactionHistory("4444444444","ljfn3lk"));
        ...
        assertEquals("withdraw of 100.0; withdraw of 300.25; deposit of 235.61; deposit of 56.29; deposit of 225", finalAtm.transactionHistory("4444444444","ljfn3lk"));
        ...
        assertEquals("transfer of 150.0 to 6666666666", finalAtm.transactionHistory("5555555555","3t3tfef"));
        assertEquals("transfer of 150.0 from 5555555555", finalAtm.transactionHistory("6666666666","r3foihf2"));
        ...
        assertEquals("transfer of 150.0 to 6666666666; deposit of 50; transfer of 25.43 from 5555555555", finalAtm.transactionHistory("5555555555","3t3tfef"));
        ...
        assertEquals("withdraw of 50.64", finalAtm.transactionHistory("7777777777","3f3f33f"));
        ...
        assertEquals("deposit of 125.0; withdraw of 56.32", finalAtm.transactionHistory("8888888888","eflkn33"));

        //valid savings acct after 1 withdraw then 1 deposit
        finalAtm.deposit("7777777777", "3f3f33f",145.13);
        assertEquals("withdraw of 50.64; deposit of 145.13", finalAtm.transactionHistory("7777777777","3f3f33f"));
        ...
        assertEquals("deposit of 125.0; withdraw of 56.32; deposit of 90.11", finalAtm.transactionHistory("8888888888","eflkn33"));
        ...
        assertEquals("transfer of 120.65 to 0000000000", finalAtm.transactionHistory("9999999999","feij302"));
        assertEquals("transfer of 120.65 from 9999999999", finalAtm.transactionHistory("0000000000","0t3082"));
        ...
        assertEquals("transfer of 120.65 to 0000000000; deposit of 50.65; transfer of 20.0 from 0000000000", finalAtm.transactionHistory("9999999999","feij302"));
